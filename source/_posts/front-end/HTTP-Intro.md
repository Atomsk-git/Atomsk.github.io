...
![Client-server-chain](HTTP-Intro/Client-server-chain.png)
...
![HTTP_Request](HTTP-Intro/HTTP_Request.png)
...
![HTTP_Response](HTTP-Intro/HTTP_Response.png)
